...
class GraphRenderer:
    ...
    def drawTopKeywords(self):
        ...
        wordfreq.update_layout(width=450,height=450)
    ...
    def drawBehavorialEmotionalChart(self):
        ...
        big5_traits_graph.update_layout(width=450,height=450)
        # Bar Plot for getting the big 5 traits along with a measure of how prevalent each trait is
        big5_traits_val_graph = px.bar(big5_traits, x='big_5_traits', color='big_5_trait_rate',color_discrete_sequence=px.colors.qualitative.Pastel,width=450,height=450)
        ...
        emotional_traits_graph.update_layout(width=450,height=450)
    ...
    def starDistribution(self):
    	...
    	star_dist.update_layout(width=450,height=450)
